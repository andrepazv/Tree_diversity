...
write_csv(comm %>% mutate(accepted_bin = gsub(" ", "_", accepted_bin)), "results/Community_matrix_for_FD_PD_38k.csv")
write_csv(dt_mat %>% mutate(accepted_bin = gsub(" ", "_", accepted_bin)), "results/Trait_matrix_for_FD_PD_38k.csv")
write.tree(pruned_tree, "results/Pruned_tree_for_FD_PD_38k.csv")
